...
class ViewControllerPlayMusic: UIViewController {
    ...
    @IBOutlet weak var imagePlus: UIButton!
    ...
    @IBAction func Plus(_ sender: Any) {
        if plusSign == 0{
            imagePlus.setImage(UIImage(systemName: "checkmark"), for: .normal)
            plusSign = 1
        }
        else{
            imagePlus.setImage(UIImage(systemName: "plus"), for: .normal)
            plusSign = 0
        }
    }
    ...
    @IBAction func playMusic(_ sender: Any) {
        if sign == 0{
            ...
            statusLabel.text = "Сейчас играет"
            sign = 1
    ...
    @IBAction func replaceFunc(_ sender: Any) {
        if replaceSign == 0{
            replaceButton.setImage(UIImage(named: "refresh 2"), for: .normal)
            replaceSign = 1
        }
        else{
